            ...
            <div className="mt-10 bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden w-full max-w-[520px]">
              ...
              <div className="flex min-h-[170px]">
                ...
                <div className="w-24 border-r border-gray-100 p-3">
                  <p className="text-[7px] font-bold mb-3">Dashboard</p>
                ...
                <div className="flex-1 p-4">
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-3">
                    <div className="bg-gray-50 rounded p-2">
                      <p className="text-[6px] text-gray-400">Revenue</p>
                      <p className="text-[10px] font-bold">$24,890</p>
                    </div>

                    <div className="bg-gray-50 rounded p-2">
                      <p className="text-[6px] text-gray-400">Orders</p>
                      <p className="text-[10px] font-bold">1,284</p>
                    </div>

                    <div className="bg-gray-50 rounded p-2">
                      <p className="text-[6px] text-gray-400">Customers</p>
                      <p className="text-[10px] font-bold">8,492</p>
                    </div>
                  </div>
            ...
            <div className="flex gap-10 mt-8">
              <div className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-full bg-[#ffded8] flex items-center justify-center">
                  <span className="text-[#ff634d] text-xs">✓</span>
                </div>
